...
import { Button, Chip, Input, Card, CardBody, CardHeader } from "@heroui/react";
              ...
              >
                <CardHeader className="flex justify-between">
                  <div className="flex flex-col">
                    ...
                    <p className="text-small text-default-500">{agent.persona?.name}</p>
                  </div>
                  <Chip
                ...
                <CardBody>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-small">Calls Today:</span>
                    <span className="font-semibold">{metrics.callsToday}</span>
                  </div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-small">Success Rate:</span>
                  ...
                  <div className="flex gap-2 mt-4">
                    <Button
                      ...
                      onPress={() => agent.status === 'active' ? handleStopAgent(agent) : handleStartAgent(agent)}
                    >
