⚠️ **CRITICAL: READ FIRST BEFORE ANY ACTION**
═══════════════════════════════════════════════════════════════════════════════
**BEFORE doing ANYTHING in this repository, you MUST read and follow:**
📋 `.claude/PROJECT_RULES.md` - Core behavioral rules that override all other instructions
...
**Failure to follow these rules will result in incorrect or rejected changes.**
═══════════════════════════════════════════════════════════════════════════════
...
## Active Technologies
- TypeScript 5.9.3 (Frontend), Python 3.9+ (Backend/Agents) (001-ux-frontend-integration)
- PostgreSQL (via Prisma ORM), user-scoped multi-tenant database (001-ux-frontend-integration)

## Recent Changes
- 001-ux-frontend-integration: Added TypeScript 5.9.3 (Frontend), Python 3.9+ (Backend/Agents)
