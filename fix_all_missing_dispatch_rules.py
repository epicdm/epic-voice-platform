#!/usr/bin/env python3
"""
Create missing dispatch rules for ALL phone numbers (regardless of deployment status)
"""
import asyncio
import os
...
async def fix_all_missing_dispatch_rules():
    """Create dispatch rules for all phone numbers missing them (ALL agents)"""
    ...
    print("🔧 Creating missing dispatch rules for ALL agents")
    print("=" * 80)
    ...
    try:
        with engine.connect() as conn:
            ...
            if not results:
                print("✅ No missing dispatch rules!")
                return
...
if __name__ == "__main__":
    asyncio.run(fix_all_missing_dispatch_rules())
