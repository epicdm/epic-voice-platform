...
class TestFusionpbxIntegrationAgentAgent(Agent):
    """
    ...
    def __init__(self) -> None:
        super().__init__(
            instructions="You are a helpful AI assistant testing FusionPBX integration."
        )
...
async def entrypoint(ctx: JobContext):
    ...
    # Start the session
    agent = TestFusionpbxIntegrationAgentAgent()
