...
class TechnicalSupportAgent11Agent(Agent):
    """
    Provides technical troubleshooting, guides users through solutions, and escalates complex issues.
...
async def entrypoint(ctx: JobContext):
    ...
    # Start the session
    agent = TechnicalSupportAgent11Agent()
