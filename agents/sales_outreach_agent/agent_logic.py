...
class SalesOutreachAgentAgent(Agent):
    """
    Proactively reaches out to leads, qualifies prospects, and schedules meetings with your sales team.
