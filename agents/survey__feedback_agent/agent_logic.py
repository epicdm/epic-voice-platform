...
class SurveyFeedbackAgentAgent(Agent):
    """
    Conducts surveys, gathers customer feedback, and collects valuable insights through conversational interviews.
...
async def entrypoint(ctx: JobContext):
    ...
    # Start the session
    agent = SurveyFeedbackAgentAgent()
