...
class TtttttAgent(Agent):
    ...
    def __init__(self) -> None:
        super().__init__(
            instructions="You are an appointment scheduling assistant. Check availability, book appointments, confirm details, and handle rescheduling. Always confirm details twice."
        )
