...
class CustomerSupportAgent(Agent):
    ...
    def __init__(self) -> None:
        super().__init__(
            instructions="You are a helpful customer support agent. Greet customers warmly, answer questions, help troubleshoot issues, and escalate complex problems when needed. Keep responses concise and clear."
        )
