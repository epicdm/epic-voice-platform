...
# Usage: ./setup-env.sh <environment> <branch>
# Example: ./setup-env.sh staging dev-branch
# Example: ./setup-env.sh prod main
...
DB_PASS="secure_password_here"  # CHANGE THIS
